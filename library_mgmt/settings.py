...
SECRET_KEY = 'django-insecure-eahiwfkr8k6a7lf*-ur7i#^*l*o3^+jq-#siza(3v*%3_n^g)q'
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'crispy_bootstrap5',  # only if using Bootstrap 5
    'library',
]
...
LOGIN_URL = '/login/'                   # Redirect if unauthenticated
